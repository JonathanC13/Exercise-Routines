...
const AddSetForm = ( { sets={}, updateExerciseRequestHandler = () => {} }) => {
  ...
  return (
    <form className="add_set__form" onSubmit={addSetHandler} ref={exSetAddFormRef}>
        ...
        <label htmlFor="add_set_order__input" className="add_set_order__label">Order</label>
        <input type="number" id='add_set_order__input' name='add_set_order__input'
            value={exSetOrder}
            onChange={(e) => {setExSetOrder(e.target.value)}}
        />

        <label htmlFor="add_set_weight__input" className="add_set_order__label">Weight</label>
        <input type="text" id='add_set_weight__input' name='add_set_weight__input'
            value={exSetWeight}
            onChange={(e) => {setExSetWeight(e.target.value)}}
        />

        <label htmlFor="add_set_reps__input" className="add_set_order__label">Reps/Duration</label>
        <input type="text" id='add_set_reps__input' name='add_set_reps__input'
            value={exSetReps}
            onChange={(e) => {setExSetReps(e.target.value)}}
        />

        <label htmlFor="add_set_rest__input" className="add_set_order__label">Rest (seconds)</label>
        <input type="number" id='add_set_rest__input' name='add_set_rest__input'
            value={exSetRest}
