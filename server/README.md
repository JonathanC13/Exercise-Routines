...
<table>
    ...
    <tr>
        ...
        <td>/:userId</td>
        <td>{"name": <mark>name</mark>, "email": <mark>email</mark>, "preferredTheme": <mark>preferredTheme</mark>}</td>
        <td>200</td>
...
base: /api/v1/routines/:routineId/sessions/
...
<table>
    ...
    <tr>
        ...
        <td>N/A</td>
        <td>/:sessionId</td>
        <td>{"name": name, "order": order, "description": description}</td>
        <td>200</td>
        <td>
            {
                "response: 
...
base: /api/v1/routines/:routineId/sessions/:sessionId/
...
<table>
    ...
    <tr>
        ...
        <td>Returns all the exercises associated with the sessionId.</td>
    </tr>
    <tr>
        <td>POST</td>
